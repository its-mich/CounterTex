...
{
    public class ProduccionDiariaController : AsyncController
    {
        ...
        private static List<ProduccionDiaria> _producciones = new List<ProduccionDiaria>()
        {
            new ProduccionDiaria { Id = "#PD-001", TipoPrenda = "Camiseta", Color = "Azul", Modelo = "Caballero", Talla = "M", Operacion = "Costura", Cantidad = 120, Fecha = new DateTime(2023, 6, 15), Estado = "Completado" },
            new ProduccionDiaria { Id = "#PD-002", TipoPrenda = "Jogger", Color = "Negro", Modelo = "Dama", Talla = "S", Operacion = "Corte", Cantidad = 85, Fecha = new DateTime(2023, 6, 15), Estado = "En Proceso" },
            new ProduccionDiaria { Id = "#PD-003", TipoPrenda = "Camisa Crop Top", Color = "Rosado", Modelo = "Dama", Talla = "L", Operacion = "Planchado", Cantidad = 64, Fecha = new DateTime(2023, 6, 14), Estado = "Completado" },
            new ProduccionDiaria { Id = "#PD-004", TipoPrenda = "Short Drill", Color = "Hueso", Modelo = "Niño", Talla = "XS", Operacion = "Empaque", Cantidad = 42, Fecha = new DateTime(2023, 6, 14), Estado = "En Proceso" },
            new ProduccionDiaria { Id = "#PD-005", TipoPrenda = "Leggings Juvenil", Color = "Blanco", Modelo = "Dama", Talla = "M", Operacion = "Control de Calidad", Cantidad = 37, Fecha = new DateTime(2023, 6, 13), Estado = "Rechazado" }
        };
        ...
        public async Task<ActionResult> CreateAsync(ProduccionDiaria produccion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> EditAsync(string id, ProduccionDiaria produccion)
        {
            if (id != produccion.Id)
            {
                return new HttpNotFoundResult();
